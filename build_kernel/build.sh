...
# set variables
FIT=GreenApple_defconfig
Flash="GreenApple-Kernel-v3.0_G900H(Dev)"

SETARCH=arm
CROSS=/home/somadsul/toolchains/UBERTC4.9/bin/arm-eabi-
IMG=arch/arm/boot
DTS=arch/arm/boot/dts
DC=arch/arm/configs

# updater-script setup
sed -i -e '/ui_print("~~~~~~~~~ GreenApple Kernel for/c\ui_print("~~~~~~~~~ GreenApple Kernel for Galaxy S5 G900H ~~~~~~~~~");' Output/META-INF/com/google/android/updater-script

sed -i -e '/by somadsul ~~~~~~~~~~~~~~~");/c\ui_print("~~~~~~~~~~~~~~~ G900H - by somadsul ~~~~~~~~~~~~~~~");' Output/META-INF/com/google/android/updater-script
...
sed -i -e '/LINUX_COMPILE_BY=$(whoami/c\LINUX_COMPILE_BY=somadsul' scripts/mkcompile_h
sed -i -e '/LINUX_COMPILE_HOST=`hostname`/c\LINUX_COMPILE_HOST=somadsul' scripts/mkcompile_h
echo "Done"
echo
